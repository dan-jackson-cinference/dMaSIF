...
import numpy as np
from Bio.PDB import PDBIO, PDBList, PDBParser, Selection, StructureBuilder
...
parser.add_argument(
    ...
    type=str,
    default="",
    help="PDB code along with chains to extract, example 1ABC_A_B",
    required=False,
)
parser.add_argument(
    "--pdb_list",
    type=str,
    default="",
    help="Path to a text file that includes a list of PDB codes along with chains, example 1ABC_A_B",
    required=False,
)
